  ...
  const founders = [
    {
      ...
      story: "As an AWS Cloud Architect, I've spent years building scalable, high-performance systems for enterprise clients. I understand the importance of reliability, precision, and seamless user experience — values I now bring to Kitchens by K's technology backbone.",
                ...
                <div className="bg-white/70 dark:bg-slate-800/70 backdrop-blur-md border border-white/40 dark:border-slate-700/40 rounded-3xl p-8 md:p-10 shadow-sm h-full flex flex-col justify-center">
                  <div className="flex items-center gap-3 mb-6">
                    ...
                    <div>
                      ...
                      <p className="text-[14px] font-semibold text-slate-900 dark:text-white">
                        {index === 0 ? "From Cloud to Kitchen" : "From Big Four to Better Food"}
                      </p>
                    </div>
                  </div>
                  ...
                  {index === 0 && (
                    <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-[14px]">
                      Today, the platform serves 50+ corporate clients with a modern PWA built on React, AWS infrastructure, and enterprise-grade DevOps practices — ensuring every click, every order, and every delivery is as smooth as the meals we serve.
                    </p>
                  )}

                  {index === 1 && (
                    <p className="text-slate-500 dark:text-slate-400 leading-relaxed text-[14px]">
                      Today, Kitchens by K serves 50+ corporate clients across Mumbai, trusted by HR directors, executives, and founders who demand the best for their teams. Every process — from sourcing ingredients to final delivery — reflects Kanak's audit-trained eye for quality and consistency.
                    </p>
                  )}
