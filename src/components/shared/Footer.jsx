...
export default function Footer() {
  return (
    <footer className="relative bg-slate-900 text-white pt-10 md:pt-12 pb-7 md:pb-8 px-6 rounded-t-[3rem] overflow-hidden">
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row items-start justify-between gap-5 md:gap-6">
          ...
          <div className="grid grid-cols-2 md:flex md:gap-12 gap-x-6 md:gap-x-8 gap-y-5 md:gap-y-6 w-full md:w-auto">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2 md:mb-2.5">Company</p>
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2 md:mb-2.5">Partner With Us</p>
              <div className="flex flex-col gap-1.5 text-[13px] text-slate-400">
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2 md:mb-2.5">Learn More</p>
              <div className="flex flex-col gap-1.5 text-[13px] text-slate-400">
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2 md:mb-2.5">Follow Us</p>
              <div className="flex flex-col gap-1.5 text-[13px] text-slate-400">
            ...
            <div className="col-span-2 md:col-span-1">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2 md:mb-2.5">Download App</p>
              <div className="flex flex-row flex-wrap md:flex-col gap-2.5 items-start justify-start w-auto h-auto">
        ...
        <div className="border-t border-slate-800 mt-6 md:mt-8 pt-5 md:pt-6 flex flex-col md:flex-row items-center justify-between gap-4">
