...
export default function Footer() {
  return (
    <footer className="relative bg-slate-900 text-white pt-12 pb-8 px-6 rounded-t-[3rem] overflow-hidden">
      <div className="aurora-mesh absolute inset-x-0 top-0 h-40 opacity-25" aria-hidden="true" />
      <div className="max-w-6xl mx-auto relative z-10">
        <div className="text-center mb-10">
          ...
          <p className="text-slate-400 mb-6 max-w-md mx-auto">Join <CountUp value={50} suffix="+" className="font-bold text-white" /> companies across Mumbai who trust us with their daily meals.</p>
          <motion.a href="mailto:hello@kitchensbyk.com" whileHover={{ scale: 1.04 }} whileTap={{ scale: 0.97 }}
            className="inline-flex items-center gap-3 bg-saffron hover:bg-saffron-dark text-white font-bold px-9 py-4 rounded-2xl text-base shadow-xl shadow-saffron/20 transition-colors">
            Get Started <ArrowRight size={18} />
          </motion.a>
        </div>

        <div className="border-t border-slate-800 pt-6 flex flex-col md:flex-row items-start justify-between gap-6">
          ...
          <div className="grid grid-cols-2 md:flex md:gap-12 gap-x-8 gap-y-6 w-full md:w-auto">
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2.5">Company</p>
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2.5">Partner With Us</p>
              <div className="flex flex-col gap-1.5 text-[13px] text-slate-400">
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2.5">Learn More</p>
              <div className="flex flex-col gap-1.5 text-[13px] text-slate-400">
            ...
            <div>
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2.5">Follow Us</p>
              <div className="flex flex-col gap-1.5 text-[13px] text-slate-400">
            ...
            <div className="col-span-2 md:col-span-1">
              <p className="text-[11px] font-semibold uppercase tracking-[0.15em] text-slate-500 mb-2.5">Download App</p>
