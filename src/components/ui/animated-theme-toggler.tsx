...
export function AnimatedThemeToggler({
  ...
  return (
    <motion.button
      ...
      className="flex h-8 w-8 items-center justify-center rounded-xl text-slate-700 dark:text-slate-200 hover:bg-slate-100 dark:hover:bg-slate-800 transition-colors"
