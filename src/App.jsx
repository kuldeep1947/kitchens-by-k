...
function AmbientDepth() {
  ...
  return (
    <div className="pointer-events-none fixed inset-0 -z-10 overflow-hidden" aria-hidden="true">
      <motion.div
        style={{ y: reduce ? 0 : y1 }}
        className="absolute left-[-10%] top-[30%] h-[520px] w-[520px] rounded-full bg-saffron/[0.07] blur-[150px] dark:bg-emerald-500/[0.07]"
      />
      <motion.div
        style={{ y: reduce ? 0 : y2 }}
        className="absolute right-[-8%] top-[60%] h-[460px] w-[460px] rounded-full bg-amber-300/[0.08] blur-[150px] dark:bg-teal-500/[0.06]"
      />
    </div>
  );
}
